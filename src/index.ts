...
const server = Server.init(3000); //acceso al metodo estatico que creamos init y el puerto
server.app.use(router);//una middleware para llamar al router
...
server.start(() => { //ya inicialixado aqui ejecutamos el metodo start, requiere un callback
